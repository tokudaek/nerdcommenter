...
call s:CreateMaps('nx', 'Comment',    'Comment', 'Xcc')
call s:CreateMaps('nx', 'Toggle',     'Toggle', 'Xc<space>')
call s:CreateMaps('nx', 'Minimal',    'Minimal', 'Xcm')
call s:CreateMaps('nx', 'Nested',     'Nested', 'Xcn')
call s:CreateMaps('n',  'ToEOL',      'To EOL', 'Xc$')
call s:CreateMaps('nx', 'Invert',     'Invert', 'm')
call s:CreateMaps('nx', 'Sexy',       'Sexy', 'Xcs')
call s:CreateMaps('nx', 'Yank',       'Yank then comment', 'Xcy')
call s:CreateMaps('n',  'Append',     'Append', 'XcA')
call s:CreateMaps('',   ':',          '-Sep-', '')
call s:CreateMaps('nx', 'AlignLeft',  'Left aligned', 'Xcl')
call s:CreateMaps('nx', 'AlignBoth',  'Left and right aligned', 'Xcb')
call s:CreateMaps('',   ':',          '-Sep2-', '')
call s:CreateMaps('nx', 'Uncomment',  'Uncomment', 'Xcu')
call s:CreateMaps('n',  'AltDelims',  'Switch Delimiters', 'Xca')
